...
def upgrade() -> None:
    ...
    with op.batch_alter_table('snapshots', schema=None) as batch_op:
        batch_op.create_index('ix_snapshot_ticker_date', ['ticker_id', 'snapshot_date'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('snapshot_id', 'expiry', 'strike', 'right', name='uq_contract_snapshot_key')
    )
